...
--> statement-breakpoint
INSERT INTO `__new_organizations`("id", "name", "slug", "plan", "max_teams", "max_members_per_team", "max_alerts_per_month", "created_at") SELECT "id", "name", "slug", "plan", "max_teams", "max_members_per_team", "max_alerts_per_month", "created_at" FROM `organizations`;--> statement-breakpoint
