    ...
    <MarketingLayout title="Documentation">
      <section class="page-section">
        <div class="container content-narrow">
          ...
          <p>
            Connect monitoring tools to auto-create incidents. Set up via the{" "}
            <a href="/app/webhooks">web dashboard</a>. Supports CloudWatch/SNS,
            Datadog, and generic JSON. Each source gets a unique URL with
